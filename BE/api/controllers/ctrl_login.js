...
exports.login = async (req, reply) => {
    ...
    if (validation.passes()) {
        try {
            const authConnection = await mysqlAsync.connection( global.connection, utils );
                try {
                    ...
                    if (tokenReceived) {                                                                                                                                                                                                  //  1)
                        jwt.verify(req.headers.token, global.PUBLIC_KEY, { algorithms: ['RS256'] }, async function(err, decoded) {
                            if (err){                                                                                                                                                                                                                                                                                                 //
                                ...
                                if (decoded.email_address == req.headers.email_address) {                                                                                                                                                 //  3)
                                    ...
                                    if (decoded.tenant) {                                                                                                                                                                                   //  4)
                                        ...
                                        var userSelectedTenant = decoded.tenant.toLowerCase();
                        
                                        var sqlObject1 = utils.createSQL("login", "select", "checkExistenceByEmailAndTenant", {
                                            "@login@email_address@" : decoded.email_address,
                                            "@login@tenant@" : userSelectedTenant,
                                        });
                                        if (sqlObject1.success == true) {
                                            results = await authConnection.query(sqlObject1.sql);
                                            console.log(sqlObject1.sql)
                                            ...
                                            if (results[0].total == 1) {                                                                                                                                                    //  5)
                                                ...
                                                if (typeof(global.connection_tenants[userSelectedTenant]) != 'undefined') {
                                                    ...
                                                    const tenantConnection = await mysqlAsync.connection( global.connection_tenants[userSelectedTenant]["DB"], utils );
                                                    try {
                                                        ...
                                                        if (sqlObject2.success == true) {
                                                            results = await tenantConnection.query(sqlObject2.sql);
                                                        ...
                                                        utils.rr2r(reply, 500, false, "login", "authenticationFailed.txt", 1, [], err, "ctrl_login:getUserIdByEmail:create SQL query", "error creating sql with reference getUserIdByEmail");
                                                    } finally {
                                                        await tenantConnection.release();
                                                    }
                                        ...
                                        //   - get available user tenants and return back the list of tenants to the user                     
                                        ...
                                        if (sqlObject1.success == true) {
                                            ...
                                            if (results[0].total == 1) {                                                                                                                                                    //  16) 
                                                ...
                                                if (req.headers.tenant != "") {
                                                    ...
                                                    utils.rr2r(reply,200,true,"login","authenticationSuccess.txt",0,[data_record],[],"ctrl_login:created login token" );           
                                                    ...
                                                    if (sqlObject2.success == true) {
                                                        results = await authConnection.query(sqlObject2.sql);
                                                        console.log(results);
                                                        ...
                                                        if (numRows == 1) {
                                                            ...
                                                            if (typeof(global.connection_tenants[userSelectedTenant]) != 'undefined') {
                                                                ...
                                                                try {
                                                                    ...
                                                                    if (sqlObject3.success == true) {
                                                                        results = await authConnection.query(sqlObject3.sql);
                                                                        if ((results.length == 0) || (results.length > 1)) {                                                                                               
                                                                            ...
                                                                            if (sqlObject4.success == true) {
                                                                                results = await authConnection.query(sqlObject4.sql);
                                                                    ...
                                                                    utils.rr2r(reply, 500, false, "login", "getError.txt", 1, [], err, "ctrl_login:login:execute SQL query", "error during login");
                                                                } finally {
                                                                    await tenantConnection.release();
                                                                }
                        ...
                        // NO TOKEN RECEIVED IN HEADER       
                            ...
                            if (sqlObject.success == true) {
                                results = await authConnection.query(sqlObject.sql);
                                
                                if (results.length == 1) {
                                    // Checking password
                                    console.log("DB auth : user : password hashed : <" + results[0].password + ">");
                                    console.log("Client  : user : password clear  : <" + req.headers.password + ">");
                                    bcrypt.compare(req.headers.password, results[0].password, async (errP, resultP) => {
                                        if (errP) {
                                                    ...
                                                    if (numRows == 1) {
                                                        ...
                                                        if (typeof(global.connection_tenants[userSelectedTenant]) != 'undefined') {
                                                            ...
                                                            try {
                                                                ...
                                                                results = await tenantConnection.query(sqlObject3.sql);
                                                                if ((results.length == 0) || (results.length > 1)) {                                                                                              
                                                                    // User cannot be uniquely identified in user database
                                                                    returnMessage = 'mailaddress '+req.headers.email_address+' found 0 or more then once in the table users in tenant database' + userSelectedTenant;
                                                                    utils.rr2r(reply,401,false,"login","authenticationFailed.txt",1,[],returnMessage,"ctrl_login:getUserIdByEmail" );                            
                                                                    ...
                                                                    if (sqlObject4.success == true) {
                                                                        results = await tenantConnection.query(sqlObject4.sql);
                                                                        if (results.length > 0) {                                                                                                           
                                                                            data_record["menu"] = results;
                                                                            utils.rr2r(reply,200,true,"login","authenticationSuccess.txt",0,[data_record],[],"ctrl_login:getUserMenuRights" );           
                                                                        } else {                                                                                                                            
